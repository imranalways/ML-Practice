...
namespace MLNetDemo01.Part12
{
    public class Demo
    {
        public static void Execute()
        {
            ...
            var split = context.Data.TrainTestSplit(trainingData, testFraction: 0.8);

            var model = pipeline.Fit(split.TrainSet);


            var matrix = context.Regression.Evaluate(model.Transform(split.TestSet), labelColumnName: "Salary");
